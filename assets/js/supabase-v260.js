(()=>{
  ...
  async function v260RequiredValue(column,ctx){
    ...
    const map={
      ...
      condition:ctx.condition,condition_name:ctx.condition,condition_text:ctx.condition,state:ctx.condition,
  ...
  async function v260AdaptiveInsertListing(ctx){
    ...
    const aliases={
      ...
      condition_name:ctx.condition,condition_text:ctx.condition,state:ctx.condition,
  ...
  function v260ListingFields(row){
    ...
    return {
      ...
      condition:v260Clean(v260Val(row,'condition','condition_name','condition_text','state')),
